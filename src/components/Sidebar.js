  ...
  return (
    ...
    <div className="h-full px-3 pb-4 overflow-y-auto    bg-gray-800">
        <ul className="space-y-2 font-medium">
            ...
            <li>
                <a href="/Projects" className="flex items-center p-2  rounded-lg   text-white   hover:bg-gray-700 group">
            ...
            <li>
                <a href="/Inventory" className="flex items-center p-2  rounded-lg   text-white    hover:bg-gray-700 group">
                <i class="ml-0.5 bi bi-box2-fill opacity-60"></i>
                <span className="flex-1 ml-3.5 whitespace-nowrap">Inventory</span>
                </a>
            </li>
            <li>
                <a href="/Calendar" className="flex items-center p-2  rounded-lg   text-white   hover:bg-gray-700 group">
                <i class="ml-0.5 bi bi-calendar-week-fill opacity-60"></i>
            ...
            <ul class="pt-6 mt-4 space-y-2 font-medium border-t   border-gray-700"/>
            ...
            <li>
                ...
                <span onClick={signInWithGoogle} className="flex-1 ml-3 whitespace-nowrap">Sign In</span>
                </a>
            </li>
            <li>
                <a href="#" className="flex items-center p-2  rounded-lg   text-white    hover:bg-gray-700 group">
